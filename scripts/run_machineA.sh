#!/usr/bin/env bash
# Machine A launcher — RTX 4090 (24GB)
# Configs: GAT + TAGCN, all 4 scenarios, all 3 balancing = 72 configs
set -euo pipefail

MACHINE="A"
CONFIG="configs/experiment_machineA.yaml"
RESULTS_DIR="./results_machineA"
LOG_DIR="logs"
LOG_FILE="${LOG_DIR}/machineA.log"
HEARTBEAT_LOG="${LOG_DIR}/machineA_heartbeat.log"
EXPECTED_CONFIGS=72
LOCK="/tmp/gnns_thesis_machineA.lock"
MAX_RETRIES=3
