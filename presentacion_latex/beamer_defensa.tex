...
\begin{frame}{Respaldo · el segundo artefacto, en detalle}
\begin{columns}[T]
\begin{column}{0.52\textwidth}
\footnotesize
...
\begin{frame}{Respaldo · por qué PR-AUC y no ROC-AUC}
\begin{center}
\small
...
\begin{frame}{Respaldo · cómo se construyó el grafo sintético}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\footnotesize
