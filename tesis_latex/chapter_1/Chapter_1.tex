...
\centering
\small
\begin{tabular}{|>{\raggedright\arraybackslash}p{2.6cm}|>{\raggedright\arraybackslash}p{3.4cm}|>{\raggedright\arraybackslash}p{4.1cm}|>{\raggedright\arraybackslash}p{4.0cm}|}
\hline
...
\hline
\textbf{Este trabajo (2026)} & Estabilidad XAI en GNNs bajo desbalance extremo, con eje real y eje sintético de \textit{ground-truth} & Trata estabilidad, plausibilidad y fidelidad como dimensiones independientes, corrige dos artefactos de evaluación y entrega una matriz de recomendación por objetivo & La inferencia sobre plausibilidad y fidelidad proviene del eje sintético \\
\hline
\end{tabular}
