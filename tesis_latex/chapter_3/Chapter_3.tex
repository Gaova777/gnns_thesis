...
\begin{itemize}
    ...
    \begin{itemize}
        \item Primera capa: entrada de 166 características $\rightarrow$ 64 unidades ocultas con ReLU.
        \item Segunda capa: 64 unidades ocultas $\rightarrow$ 2 clases (lícita/ilícita) con softmax.
    \end{itemize}
