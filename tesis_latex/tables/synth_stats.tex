...
\bottomrule
\end{tabular}
\caption{Prueba de Kruskal-Wallis y tamano de efecto eta cuadrado de cada factor sobre cada métrica en el grafo sintetico. El explicador ejerce el efecto dominante en las tres metricas, la arquitectura solo en la estabilidad, y el balanceo resulta despreciable.}
