...
\bottomrule
\end{tabular}
\caption{Resultados de la matriz factorial sintética por arquitectura y explicador (media sobre 3 semillas de modelo, grafo g0). Los valores n/d corresponden a métricas que un explicador no produce por diseño. Fidelity+ se calcula con la definición manual uniforme (caída de probabilidad al retirar el top-k) para los tres explicadores. PGExplainer domina la plausibilidad de aristas, GNNExplainer la de features y la fidelidad, y GNNShap la estabilidad.}
